							...
							while (!secondOptionChoice.equals("q")) {
								...
								if (secondOptionChoice.equals("1")) {
									...
									if (thirdOptionChoice.equals("1")) {
										...
										// klarer ikke � invitere deltakere dersom steg ikke er angitt
										System.out.println(chosen_event.getPlace());//SKAL VEKK
										System.out.println(chosen_event.getRoom());//SKAL VEKK		Alle rom er null! Klarer ikke hente info om rom tilh�rende events fra databasen
