...
public class Event implements Comparable<Event>{
	...
	public String toString() {
		String str = this.title + " har følgende deltakere " + peopleGoing.toString() + "og avholdes kl: " + getHour() + ":";
		if (Integer.parseInt(getMinute()) < 10){
			str += "0";
		}
		return  str + this.getMinute() + ", den " + this.getDay() + ". " + this.getMonth();		// m�neden blir ikke omgjort til streng som �nskelig :(
	}
