...
public class Employee {
	...
	private Collection<Event> declinedEvents;	//boer ogsï¿½ sorteres paa startTime
...
// returnerer true hvis employee-objektet er tilgjengelig i tidsrommet
	...
	private void removeEvent(Event event){
		if (upcomingEvents.contains(event)){
			upcomingEvents.remove(event);
		} else if (eventsAttending.contains(event)){	// dersom feil oppstï¿½r, kan vi gjï¿½re denne til ren 'if'
